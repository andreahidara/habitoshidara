...
import { Mail, Lock, ArrowRight, ShieldCheck, Sparkles, Leaf, CheckCircle2 } from "lucide-react"
...
export function AuthScreen() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.error) {
      ...
      setSuccessMsg("Bóveda creada. Revisa tu email o inicia sesión directamente.")
      setIsLogin(true)
      setPassword("")
    }
    setLoading(false)
  ...
  return (
    <div className="min-h-screen flex selection:bg-[#3a5a40]/30 selection:text-[#283618] bg-[#e9e0d8] dark:bg-[#0a0f0a]">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-16 bg-[#3a5a40]/5 dark:bg-[#1b221b] relative overflow-hidden transition-colors border-r border-[#3a5a40]/10 dark:border-white/5">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-[#a47148]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="text-center sm:text-left mb-2">
                <h1 className="text-5xl font-black text-[#283618] dark:text-white tracking-tighter uppercase leading-none flex items-center justify-center sm:justify-start gap-4">
              ...
              <AnimatePresence>
                ...
                {successMsg && (
                  <motion.div
                    ...
                    animate={{ scale: 1, opacity: 1 }}
                    exit={{ scale: 0.9, opacity: 0 }}
                    className="p-5 bg-[#3a5a40]/10 dark:bg-[#3a5a40]/20 border-2 border-[#3a5a40]/30 text-[#3a5a40] dark:text-[#a3b18a] rounded-[1.5rem] text-sm font-black uppercase tracking-wider shadow-inner flex items-center gap-3"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div className="space-y-3 group">
                  <label htmlFor="auth-email" className="text-xs font-black text-[#3a5a40] dark:text-[#a3b18a] uppercase tracking-widest ml-4 opacity-60">
                    Correo Electrónico
                  </label>
                ...
                <div className="space-y-3 group">
                  <label htmlFor="auth-password" className="text-xs font-black text-[#3a5a40] dark:text-[#a3b18a] uppercase tracking-widest ml-4 opacity-60">
                    Llave Maestra
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none text-[#3a5a40] group-focus-within:text-[#a47148] transition-colors">
