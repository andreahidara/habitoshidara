...
export function PlannerView() {
  ...
  const handleEventClick = (arg: EventClickArg) => {
    setDeletingEvent({ id: arg.event.id, title: arg.event.title })
  ...
  return (
    <div className="flex flex-col gap-12 w-full">
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={(open) => { if (!open) { setIsDeleteDialogOpen(false); setDeletingEvent(null) } }}>
          ...
          <div className="bg-gradient-to-r from-red-500 to-red-400 px-8 py-6 relative overflow-hidden">
            ...
            <DialogHeader className="relative z-10 text-left">
              <DialogTitle className="text-2xl font-black text-white tracking-tighter flex items-center gap-3 uppercase leading-none">
                <Trash2 className="w-6 h-6 opacity-90" /> Eliminar Evento
              </DialogTitle>
